#' Computes quasiconvex/quasiconcave least squares estimate with or without 
#' additional monotonicity constraint via CPLEX  or Gurobi.
...
#' @param tol            Relative MIP optimality gap tolerance. Can be any nonnegative number. Default 1e-4.@param optimizer      Which optimizer to use when solving the MIQP.  The user must input one of the following two types: 'gurobi' or 'cplex'. Make sure they installed locally and accesbible frome the R envoirment. 
...
#'
#' ret = Quasi.reg(X, y,Shape ="QuasiConvex", Monotone = "non.inc", Max.b = 10^4, MM =10^4, ep =0.001,  time.limit= 200, tol =  1e-06, optimizer= "gurobi")
#' 
#' 
